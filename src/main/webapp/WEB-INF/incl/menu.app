...
<div id="cssmenu">
	<ul>
				...
				<sec:authorize access="hasRole('ROLE_ADMIN')">
					...
					<li><a href="/spottedall"><s:message code="menu.spotted"/></a></li>
					<li><a href="/admin/adminposts"><s:message code="menu.news"/></a></li>
				...
				<sec:authorize access="hasRole('ROLE_USER')">
					...
					<li><a href="/spottedall"><s:message code="menu.spotted1"/></a></li>
					<li class="marginLeft"><a href="/student/profilusers"><s:message code="menu.profil"/></a></li>
				</sec:authorize>
				<sec:authorize access="hasRole('ROLE_PROFESOR')">
					<li><a href="/profesor/profilprof"><s:message code="menu.konto"/></a></li>
					<li><a href="/profesor/myconsultationsprof"><s:message code="menu.konsmanage"/></a></li>
					<li><a href="/profesor/profesorposts"><s:message code="menu.aktualno"/></a></li>
					<li><a href="/spottedall"><s:message code="menu.spotted2"/></a></li>
